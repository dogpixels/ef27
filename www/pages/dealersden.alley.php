...
<section class="two_columns just">
		<div>
			...
			<ul>
				<li class="retain">You must be an attendee of Eurofurence and can be identified with your conbadge, which says you paid the convention fee.</li>
				<li class="retain">No reservation: First come, first serve every day!</li>
				<li class="retain">No extra security service. But when you see something suspicious or have trouble with one of the customers you can always talk to the Security or the Dealers' Den team.</li>
				<li class="retain">Absolutely NO adult material! This is a transition area which must stay “clean” at all costs unless you want to bear the consequences.</li>
				<li class="retain">We try to provide every table with power.</li>
				<li class="retain">Anybody with the convention status “Staff” or higher can order you to remove suspicious material, anybody from the Dealers' Den or the Security Team can ask you to clean your table and leave the Artist Alley.</li>
			</ul>
		</div>
		<div>
			...
			<ul>
				...
				<li class="retain">Additionally, we do not allow the sale of sex toys, fetish gear and other items that the management of the Dealers' Den deems inappropriate.</li>
				<li class="retain">Copyrighted material (see the subject "Fan Art" below) might be displayed but not for sale!</li>
		...
		<div>
			...
			<ul>
				<li class="retain">Do not block more than one single table for yourself.</li>
				<li class="retain">Be polite.</li>
				<li class="retain">If there are any problems among the artists please feel free to contact the Dealers' Den team we are there to help.</li>
				<li class="retain">When you are done for the day or got enough commissions/work to spend some time with, we appreciate to clear the table for some other artist or dealer to get a chance offering their goods and talent.</li>
			</ul>
		</div>
</section>
