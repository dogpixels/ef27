...
<section>
	<p>Watch other attendees travel towards Eurofurence (or back)!</p> All you'll need to participate is a smart phone and the <a href="http://glympse.com/get-glympse" target="_blank">Glympse app</a>.</p>
	...
	<h3>Attribution</h3>
	<ul>
		<li>Thanks to Dibs Razell for having this idea!</li>
	</ul>

</section>

<script>
	function fullglympse() {
		$("#glympser").addClass("fullscreen");
	}
</script>