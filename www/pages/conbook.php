...
<h2>Illustrations<span class="font14"> (If you're an artist, this one is for you!)</span></h2>
<section class="two_columns just">
	<ul>
		<li class="retain">The con book is in full color, so we prefer color illustrations as well.</li>
		<br/>
		<li class="retain">We are looking for full page illustrations as well as smaller fillers.</li>
		<br/>
		<li class="retain">The format for full page illustrations is A4, upright (210 x 297mm) plus 3mm cropping area along all edges, adding up to a total of 216 x 303 mm or 2551 x 3578 pixels at 300 dpi.<br /><br />
			<img src="img/pages/conbook/How-to-conbook_1.jpg" alt="How to Conbook" />
		</li>
		<br/>
		<li class="retain">File format should be JPG set to highest quality (low information loss). Other formats are acceptable too but may cause issues due to the resulting file size.</li><br/>
		<li class="retain">For a full page illustration, do not draw anything important into the cropping area. Please avoid symmetrical motifs or motifs that rely on exact cutting of the page &ndash; for technical reasons, the cropping of the finished book may occur anywhere in the cropping area of each page.</li><br/>
		<li class="retain">Fillers that do not have an illustrated background (extracted cutouts) need to have a fully transparent image background, since the pages themselves will have their own color background. The foreground needs to be intransparent (opaque). Be careful about holes in the foreground (transparent) and white foreground elements (opaque)!<br /><br />
			<img src="img/pages/conbook/How-to-conbook_2.jpg" alt="How to Fillers" /> 
		</li>
		<br/>
		<li class="retain">To submit illustrations that contain transparency, please use the PNG format.</li>
		<br />
		<li class="retain">The submission must NOT exceed PG-13 rating.</li>
		<br />
		<li class="retain">The artists for the cover art work and the centerfold will be chosen and approached directly by the team.</li>
	</ul>
...
<h2>Advertising</h2>
<section class="two_columns just">
	<p class="retain">Eurofurence supports fellow conventions! Ads for conventions are run free of charge, preferrably as ad exchange. The number of available spots for such ads are limited (and subject to layout needs), so let us know your interest early on!</p>
	<p class="retain">We are aware that date requirements do not always allow a meaningful swap, so please add your convention's dates (including the con book deadlines) with your request.</p>
	<p class="retain">Full color ads are supported. Formats compatible with the European norm A4 (A5, A6) are preferred. (See also the formatting hints under "Illustrations".)</p>
	<p class="retain">The con book does not accept paid ads at this time due to mandatory taxes and other required overhead.
