...
<section class="uk-column-1-2@l">
	...
	<div>
		...
		<ul>
		  ...
		  <li>No "fun amounts" like "three times pi plus seven" please. We do not want to solve 
		  mathematical equations. (Especially when it does not even amount to whole Euros.)</li>
		  <li>The bid needs to be <i>as much as or more</i> than the minimum bid, and <i>more</i> than 
		  any previous bid.</li>
		...
		<ul>
		  ...
		  mistaken bids, the buyer can inform the Art Show management, which will replace the bidsheet 
		  and invalidate the bid.</li>
		  <li>A buyer must keep his bid sticker sheet safe, to prevent others to bid in his name.</li>
		  <li>Collusion between artist/agent and buyer is forbidden. Fake bids, bids on one's own 
	...
	<div>
		...
		<ul>
		  ...
		  the art you were interested in, and the total sum.</li>
		  ...
		  <li>If you make a mistake, come to the Art Show counter and ask the personnel about it. Do not
		  change a bidsheet on your own, this will cause irritations.</li>
		  <li>We cannot answer specific questions on art pieces beyond the information on the bidsheet.
		  You may be able to contact the artist to ask her or him personally. Perhaps you can find the
		  artist in the Dealers' Den.</li>
		  <li>Please do not assume you have won nothing, or won everything. If you have placed any bids, check
		  the winner lists or ask at the sales counter. Even if your favorite piece has gone to auction and
		  you missed the auction altogether, it might still be yours if no one else bid on it.</li>
		  <li>Some art comes with packaging; there will be small numbered tickets with the bidsheets. You
		  will receive some packaging with the art at sales time (may be complete boxes or just bubble wrap). 
		  This may not be totally sufficient for transport (esp. overseas) but should help you in securing
		  your purchased art a bit better.</li>
		  <li>The bid stickers keep the bidding semi-anonymous, but naturally anybody may see you placing
		  a bid. Likewise, in the auction you need to speak up to bid. Anonymity is not guaranteed.</li>
